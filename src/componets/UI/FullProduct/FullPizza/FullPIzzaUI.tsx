...
import CollectionDopProducts from "../../CollectionDopProduct/CollectionDopProductsUI";
...
const FullPizza = () => {
	...
	}, [activeType.typeInfo, activeSize, sizes.length, types.length])
            ...
            <div className={styles.fullProduct}>
                ...
                <div className={styles.item}>
                    <div className={styles.item_right_description}>
                        <div className={styles.item_right_description_title}>
                            ...
                            <div className={styles.info}>
                                {(activeType.typeInfo.pizza_info) && <DopInfo infoArray={activeType.typeInfo.pizza_info}/>}
                            </div>
                        </div>
                        <p>{description}</p>
                    ...
                    <div className={styles.item_right_bottom}>
                        <OrangeButtonUI onClick={addInCart} title={`Добавить в корзину за ${price} ₽`}/>
                    </div>
                </div>
            </div>
            <div className={styles.item_right_bottomBTN_mobile}>
                <OrangeButtonUI onClick={addInCart} title={`Добавить в корзину за ${price} ₽`}/>
            </div>
        </div>
